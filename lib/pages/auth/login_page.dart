...
import 'package:sneakers_app/pages/auth/register_page.dart';
import 'package:sneakers_app/service/auth_service.dart';
import 'package:sneakers_app/service/database_service.dart';
                ...
                child: Form(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const Text("Login now to shop what you want!",
                            style: TextStyle(
    ...
    if (formKey.currentState!.validate()) {
      ...
      await authService
        ...
        if (value == true) {
          ...
          nextScreenReplace(context, MainNavigator());
        } else {
